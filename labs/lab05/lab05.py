...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    dest_city = make_city('dest',lat,lon)
    dist1 = distance(dest_city,city_a)
    dist2  = distance(dest_city,city_b)
    return city_a[0] if dist1 <= dist2 else city_b[0]
